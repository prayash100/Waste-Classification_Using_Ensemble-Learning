...
def process_images_with_meta_learner(folder_path):
    predictions = []
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(('.jpg', '.png', '.jpeg')):
            ...
            if not boxes:
                print(f"No objects detected in {filename}, passing to ResNet.")
    ...
    np.save("staking/meta_predictions_non_biodegradable.npy", np.array(predictions))
    print("Meta-learner predictions saved successfully!")

# Folder containing images for testing
test_folder = "testing_dataset/non_biodegradable"
process_images_with_meta_learner(test_folder)
