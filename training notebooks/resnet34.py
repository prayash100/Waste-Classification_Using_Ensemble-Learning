...
# Load Dataset
data_dir = "/content/drive/MyDrive/resnet dataset"
print("✅ Dataset Found!")
...
for epoch in range(num_epochs):
    ...
    if avg_loss < best_loss:
        best_loss = avg_loss
        model_path = "/content/drive/MyDrive/resnet34_biodegradable_best.pt"
...
model_path = "/content/drive/MyDrive/resnet34_biodegradable_best.pt"  # Update path if needed
